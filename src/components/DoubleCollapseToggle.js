...
export default function DoubleCollapseToggle(props) {
	return (
		<div className="DoubleCollapseToggle">
		  ...
		  >
		  	<img src={props.isLeftCollapsed ? expandLeftIcon : collapseLeftIcon} alt="collapse left" title="Collapse Grid" />
		  </div>
		  <div 
		  ...
		  >
		  	<img src={props.isRightCollapsed ? expandRightIcon : collapseRightIcon} alt="collapse right" title="Collapse Pattern" />
		  </div>
		</div>
	);
}